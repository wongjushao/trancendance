...
import { ChevronLeft, ChevronRight, FileDown, MessageSquare, CheckCircle } from "lucide-react";
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/5">
                {lessonData.prevLesson ? (
                  <Link to={`/courses/${courseId}/lessons/${lessonData.prevLesson.id}`}>
                ...
                {lessonData.nextLesson && (
                  <Link to={`/courses/${courseId}/lessons/${lessonData.nextLesson.id}`}>
                    <GlowButton variant="primary">
                      Next Lesson
          ...
          <GlowCard>
                ...
                <div key={comment.id} className="flex gap-4 p-4 bg-[#12121A] rounded-xl">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-[#6B6B80] text-sm">{comment.time}</span>
                    </div>
                    <p className="text-[#A0A0B5] mb-2">{comment.text}</p>
            ...
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-[#12121A] border border-white/10 rounded-xl text-white placeholder:text-[#6B6B80]"
              />
