    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="lessons" className="w-full">
        ...
        <TabsContent value="students" className="mt-6">
          <GlowCard>
            <h3 className="text-xl font-semibold text-white mb-4">Enrolled Students ({students.length})</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {students.map((student) => (
                <div key={student.id} className="flex items-center gap-4 p-4 bg-[#12121A] rounded-xl">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <div className="flex-1 h-2 bg-[#16161F] rounded-full overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-purple-500 to-violet-600"
                          style={{ width: `${student.progress}%` }}
                        />
                      </div>
                      <span className="text-xs text-[#6B6B80]">{student.progress}%</span>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <TabsContent value="discussion" className="mt-6">
          <GlowCard>
            <div className="text-center py-12">
              <MessageSquare className="w-16 h-16 text-[#6B6B80] mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Join the Discussion</h3>
              <p className="text-[#A0A0B5] mb-6">Connect with other students and instructors</p>
              <GlowButton variant="primary">
                Start a Discussion
              </GlowButton>
            </div>
