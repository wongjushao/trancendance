...
import { useRouter } from "next/navigation"; // Updated from react-router
...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Simulate login
    setTimeout(() => {
      // In Next.js, navigation uses router.push()
      router.push("/");
    }, 1500);
  };
      ...
      <div className="bg-[#16161F] border border-white/10 rounded-3xl p-8 shadow-2xl shadow-purple-500/10">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="/forgot-password" title="forgot-password" className="text-purple-400 hover:text-purple-300">
              Forgot password?
            </Link>
          </div>
