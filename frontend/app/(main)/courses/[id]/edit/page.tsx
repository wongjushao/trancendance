                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-slate-800/30 rounded-lg">
                      <div>
                        <h4 className="font-medium text-white">Duplicate Course</h4>
                        <p className="text-sm text-gray-400">Create a copy of this course with all content</p>
                      </div>
                      <GlowButton variant="secondary" onClick={() => toast.info("Duplicate feature coming soon")}>
                    ...
                    <div className="flex items-center justify-between p-3 bg-slate-800/30 rounded-lg">
                      <div>
                        <h4 className="font-medium text-white">Export Course</h4>
                        <p className="text-sm text-gray-400">Export course data for backup or migration</p>
                      </div>
                      <GlowButton variant="secondary" onClick={() => toast.info("Export feature coming soon")}>
                        <Download className="w-4 h-4 mr-2" />
                        Export
                      </GlowButton>
                    </div>

                    {/* Organization Transfer Section */}
                    <div className="border border-yellow-500/30 rounded-lg p-6 bg-yellow-500/5">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-white mb-2">Transfer Course to Another Organization</h3>
                          <p className="text-sm text-gray-400 mb-4">
                            Move this course to a different organization. This is useful if the course was created under the wrong organization.
                            All course content, modules, lessons, and assignments will be preserved.
                          </p>
                          <div className="flex items-center gap-3">
                            ...
                            {course.organization_id && (
                              <span className="text-xs text-gray-500">
                                Current org ID: {course.organization_id}
                              </span>
                            )}
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-red-500/10 rounded-lg border border-red-500/30">
                      <div>
                        <h4 className="font-medium text-red-400">Delete Course</h4>
                        <p className="text-sm text-gray-400">Permanently delete this course and all its content</p>
                      </div>
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Track engagement and performance</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  <div className="bg-slate-800/50 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-white">
                      {course.course_classes?.reduce((sum, c) => sum + (c.members?.filter(m => m.role === 'student').length || 0), 0) || 0}
                    </div>
                  ...
                  <div className="bg-slate-800/50 rounded-lg p-4 text-center">
                    ...
                    <div className="text-sm text-gray-400">Active Offerings</div>
                  </div>
                  <div className="bg-slate-800/50 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-white">
                      {course.modules?.reduce((sum, m) => sum + m.classes.reduce((s, c) => s + c.lessons.length, 0), 0) || 0}
                    </div>
                    <div className="text-sm text-gray-400">Total Lessons</div>
                  </div>
                  <div className="bg-slate-800/50 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-white">
                      {course.modules?.reduce((sum, m) => sum + m.classes.reduce((s, c) => s + (c.lessons.filter(l => l.assignments?.length).length || 0), 0), 0) || 0}
                    </div>
                    <div className="text-sm text-gray-400">Assignments</div>
                  </div>
                </div>
                
                {/* More analytics charts would go here */}
                <div className="bg-slate-800/30 rounded-lg p-8 text-center text-gray-400">
                  <BarChart3 className="w-12 h-12 mx-auto mb-3 opacity-50" />
                  <p>Detailed analytics will be available after student enrollments</p>
                </div>
              </div>
            </GlowCard>
          </TabsContent>
