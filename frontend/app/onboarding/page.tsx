...
export default function OnboardingPage() {
  ...
  const handleNext = () => {
    if (currentStep < TOTAL_STEPS) {
      ...
      // Logic for submitting to Supabase or your backend would go here
                    ...
                    <div className="space-y-8 py-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <button className="p-5 bg-[#12121A] border border-white/5 rounded-2xl hover:border-purple-500/40 hover:bg-purple-500/5 transition-all text-left group">
                          <p className="text-white font-semibold mb-1 group-hover:text-purple-400">Join Existing</p>
                          <p className="text-[#6B6B80] text-xs leading-relaxed">Enter a unique code provided by your institution.</p>
                        </button>
                        <button className="p-5 bg-[#12121A] border border-white/5 rounded-2xl hover:border-purple-500/40 hover:bg-purple-500/5 transition-all text-left group">
                          <p className="text-white font-semibold mb-1 group-hover:text-purple-400">Create New</p>
